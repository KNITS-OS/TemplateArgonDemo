...
export const groups: Group[] = [
  ...
  {
    id: 6,
    name: "Ancient Anarchy",
    description: "Hard to drive them. But they know how to get there",
    active: true,
    members: [51, 52, 53, 54],
  },
  {
    id: 7,
    name: "Soul Glory",
    description: "No indulgence on the threats of bad habits",
    active: true,
  ...
  },
  {
    id: 10,
    name: "Sting Pirates",
    description: "Sharp and humorous with a taste of insulting in rhyme",
    active: true,
    members: [91, 92, 93, 94, 95, 96, 97, 98],
  },
  {
    id: 11,
    name: "Copy $ Kaos",
