...
MapsHeader.propTypes = {
  ...
  onActiveMembersClick: PropTypes.func.isRequired,
  onNewMembersClick: PropTypes.func.isRequired,
  onSelfResignedClick: PropTypes.func.isRequired,
  onAutoOffboardedClick: PropTypes.func.isRequired,
};
